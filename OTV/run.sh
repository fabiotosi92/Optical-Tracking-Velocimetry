...
max_features_to_track=20000
resolution=F
region_step=100
detector=FAST #ORB,GFTT,SIFT,SURF
...
./build/river_flow_velocity_estimation $path_video $path_file_params $path_file_lk $path_output $path_mask
